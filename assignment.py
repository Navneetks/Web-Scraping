...
import pandas as pd
import os                                                   #NAVANEETH KS (navaneethks75@gmail.com)(copyright)
...
chromedriver = r"C:/Users/user/AppData/Local/Temp/Temp2_chromedriver_win32.zip/chromedriver.exe" # path to the chromedriver executable
...
def get_data(soup):
    ...
    h.append(var)
    with open(r"C:\Users\user\Desktop\assignment.json",'r+') as f:
        feeds = json.load(f)
        for i in h:
...
with open(r"C:\Users\user\Desktop\assignment.json", mode='w', encoding='utf-8') as f:
    json.dump(v,f)
...
df = pd.read_json(r"C:\Users\user\Desktop\assignment.json")    #Here i am reading json file saved on my desktop and converting to csv
df.to_csv(r"C:\Users\user\Desktop\book1.csv")
